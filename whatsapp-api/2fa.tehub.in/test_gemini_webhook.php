...
// Test calling chatbot.php webhook locally
echo "=== Testing Chatbot Webhook with gemini-3.5-flash ===\n";
$chatbot_url = "http://127.0.0.1/api/chatbot.php";
$webhook_payload = [
    'sender' => '1234567890',
    'message' => 'I am looking to buy Red Sandalwood Plantation, what are the details?',
    'session_id' => 'default'
];
...
if (!empty($web_err)) {
    echo "Webhook cURL Error: $web_err\n";
}
echo "Webhook Response: " . $web_res . "\n";
