  ...
  window.zamzyChat = {
    ask: function(topic) {
      if (topic === 'download') {
        ...
        this.addMsg('How can I get a discount coupon?', 'user');
        setTimeout(() => {
          this.addMsg('🎟️ For discount coupons and special offers, please contact our administrator directly on WhatsApp at <strong><a href="https://wa.me/917287060553?text=Hi%20ZAMZY%2C%20I%20would%20like%20to%20request%20a%20discount%20coupon" target="_blank" style="color:#818cf8; text-decoration:underline;">+91 72870 60553</a></strong> or email <strong><a href="mailto:work@zamzy.in" style="color:#818cf8;">work@zamzy.in</a></strong>.', 'bot');
        }, 400);
      } else if (topic === 'otp') {
        this.addMsg('I did not receive my OTP code', 'user');
        setTimeout(() => {
          this.addMsg('Please ensure you entered a valid 10-digit WhatsApp number. We dispatch codes via WhatsApp (+91) and Email simultaneously. Check your WhatsApp chats and email spam folder, or contact <strong>work@zamzy.in</strong>.', 'bot');
        }, 400);
      } else if (topic === 'support') {
        this.addMsg('How do I contact support?', 'user');
        setTimeout(() => {
          this.addMsg('Our support team is ready to help! 📧 Email: <strong><a href="mailto:work@zamzy.in" style="color:#818cf8;">work@zamzy.in</a></strong><br>📱 WhatsApp: <strong><a href="https://wa.me/917287060553" target="_blank" style="color:#818cf8;">+91 7287060553</a></strong>', 'bot');
        }, 400);
      }
    },
    ...
    handleSubmit: function(e) {
      ...
      setTimeout(() => {
        ...
        } else if (lower.includes('coupon') || lower.includes('discount') || lower.includes('code') || lower.includes('offer') || lower.includes('promo')) {
          this.addMsg('🎟️ For discount coupons and special promotional offers, please contact our administrator on WhatsApp at <strong><a href="https://wa.me/917287060553?text=Hi%20ZAMZY%2C%20I%20would%20like%20to%20request%20a%20discount%20coupon" target="_blank" style="color:#818cf8; text-decoration:underline;">+91 72870 60553</a></strong> or email <strong>work@zamzy.in</strong>.', 'bot');
        ...
        } else if (lower.includes('contact') || lower.includes('email') || lower.includes('help') || lower.includes('phone') || lower.includes('whatsapp') || lower.includes('admin')) {
          this.addMsg('You can reach our administrator & helpdesk directly at <strong><a href="mailto:work@zamzy.in" style="color:#818cf8;">work@zamzy.in</a></strong> or WhatsApp at <strong><a href="https://wa.me/917287060553" target="_blank" style="color:#818cf8;">+91 7287060553</a></strong>.', 'bot');
        } else {
          this.addMsg('Thank you for reaching out! For assistance, coupon requests, or inquiries, please message our admin at <strong>+91 72870 60553</strong> or email <strong>work@zamzy.in</strong>.', 'bot');
        }
      }, 500);
