...
<header>
  <div class="logo-block" style="display: flex; align-items: center; gap: 12px;">
    ...
    <div>
      <div class="tagline" style="font-size: 10px; color: var(--cyan); margin-top: 2px; font-family: var(--font-mono); text-transform: uppercase; letter-spacing: 1px;">Cluster &amp; Gateway Settings</div>
    </div>
  </div>
  <nav>
