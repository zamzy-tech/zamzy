                        ...
                        <form class="pt-3 edit-staff-form" id="edit-form" action="<?php echo e(url('staff')); ?>" novalidate="novalidate">
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <?php if(!empty($extraFields) && Auth::user()->school_id): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shacartc/school.tehub.in/resources/views/staff/index.blade.php ENDPATH**/ ?>