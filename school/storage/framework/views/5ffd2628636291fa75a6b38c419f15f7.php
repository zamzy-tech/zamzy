                    ...
                    <div class="card-body">
                        ...
                        <form class="pt-3 mt-6 create-form" method="POST" data-success-function="formSuccessFunction" action="<?php echo e(url('form-fields')); ?>">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-2">
                                    <label><?php echo e(__('user_type')); ?> <span class="text-danger">*</span></label>
                                    <select name="user_type" class="form-control"> 
                                        <option value="" selected><?php echo e(__('select_user_type')); ?></option>
                                        <option value="1"><?php echo e(__('Student')); ?></option>
                                        <option value="2"><?php echo e(__('Teacher')); ?>/<?php echo e(__('Staff')); ?></option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-3" id="toolbar">
                            <div class="form-group col-sm-12 col-md-4">
                                <label class="filter-menu"><?php echo e(__('user_type')); ?> <span class="text-danger">*</span></label>
                                <select required name="filter_all_user_type" class="form-control" id="filter_all_user_type">
                                    <option value=""><?php echo e(__('all_user_type')); ?></option>
                                    <option value="1"><?php echo e(__('Student')); ?></option>
                                    <option value="2"><?php echo e(__('Teacher')); ?>/<?php echo e(__('Staff')); ?></option>
                                </select>
                            </div> 
                        ...
                        <table aria-describedby="mydesc" class='table reorder-table-row' id='table_list'
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="user_type"><?php echo e(__('user_type')); ?></th>
                                            ...
                                            <?php $__currentLoopData = $data->default_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-6 col-md-4 form-check mr-4">
                                                    <label class="form-check-label" style="white-space: normal; word-wrap: break-word;">
                                                        <input type="checkbox" class="form-check-input chkclass" value="<?php echo e($value); ?>">
                                                        <?php echo e($value); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shacartc/school.tehub.in/resources/views/form-fields/index.blade.php ENDPATH**/ ?>