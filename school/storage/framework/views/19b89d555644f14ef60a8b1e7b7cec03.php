...
<script src="<?php echo e(asset('/assets/school/js/script.js')); ?>"></script>
...
<script src="<?php echo e(asset('/assets/school/js/script-js.js')); ?>"></script>
...
<script>
    // Logo
    var nav_logo = "<?php echo e($schoolSettings['horizontal_logo'] ?? ''); ?>";
    if (nav_logo == null || nav_logo == '') {
        nav_logo = "<?php echo e($systemSettings['horizontal_logo'] ?? asset('assets/landing_page_images/Logo1.svg')); ?>";
    }

    var footer_logo = "<?php echo e($schoolSettings['footer_logo'] ?? ''); ?>";
    ...
    // Favicon
    $('.school-favicon').attr('href', "<?php echo e($schoolSettings['favicon'] ?? $systemSettings['favicon'] ?? asset('assets/favicon.svg')); ?>");
    ...
    let upperFileBtn = document.querySelector('.upperFileUpload button');
    if (upperFileBtn) {
        upperFileBtn.addEventListener('click', function () {
    ...
    let lowerFileBtn = document.querySelector('.lowerFileUpload button');
    if (lowerFileBtn) {
        lowerFileBtn.addEventListener('click', function () {
    ...
    let aadharFileBtn = document.querySelector('.aadharFileUpload button');
    if (aadharFileBtn) {
        aadharFileBtn.addEventListener('click', function () {
            document.querySelector('.aadharFileUpload input[type="file"]').click();
        });

        document.querySelector('.aadharFileUpload input[type="file"]').addEventListener('change', function () {
            var file = this.files[0];
            var fileName = file ? file.name : 'No File Selected.';
            document.querySelector('.aadharFileUpload span').textContent = fileName;
        });
    }
...
<?php /**PATH /home/shacartc/school.tehub.in/resources/views/layouts/school/footer_js.blade.php ENDPATH**/ ?>