        ...
        <section class="admissionPage ">
            <div class="commonMT commonWaveSect">
                <div class="container">
                        ...
                        <form class="pt-3 student-registration-form online-admission-form" enctype="multipart/form-data" action="<?php echo e(route('online-admission.store')); ?>" method="POST" novalidate="novalidate">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="row formWapper">
                                        <div class="col-lg-8">
                                            <div class="row formDiv">
                                                    ...
                                                    <div>
                                                        <select name="class_id" id="class_id">
                                                            ...
                                                            <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($class->id); ?>"><?php echo e($class->name.' '. $class->medium->name.' '.($class->stream->name ?? '')); ?></option>
                                                ...
                                                <div class="col-lg-6 inputWrapper">
                                                    <label for="aadhar_pic">Aadhar Pic <span>*</span></label>
                                                    <div class="file-upload aadharFileUpload">
                                                        <div class="file-select">
                                                            <button type="button">Browse...</button>
                                                            <span>No File Selected.</span>
                                                            <input type="file" name="aadhar_pic" id="aadharUpload" accept="image/*,application/pdf" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="fileInputWrapper">
                                                <div>
                                                    <img src="<?php echo e(asset('assets/school/images/Image Preview.png')); ?>" alt="imgPreview" class="upperImgPreview default-image">
                                                </div>
                                                ...
                                                <?php elseif($data->type == 'dropdown'): ?>
                                                    ...
                                                    <?php elseif($data->type == 'file'): ?>
                                                        <div class="input-group col-xs-12">
                                                            <?php echo e(Form::file('extra_fields['.$key.'][data]', ['class' => 'file-upload-default', 'hidden', 'id' => $data->type.'_'.$key, ($data->is_required ? 'required' : '')])); ?>

                                                            <?php echo e(Form::text('', '', ['class' => 'form-control file-upload-info', 'disabled' => '', 'placeholder' => __('image')])); ?>

                                                            <span class="input-group-append">
                                                                <button class="file-upload-browse btn btn-theme" style="background-color: #D8E0E6;" type="button"><?php echo e(__('upload')); ?></button>
                                                            </span>
                                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row formDiv">
                                                ...
                                                <div class="col-lg-6 inputWrapper">
                                                    ...
                                                    <input type="email" placeholder="Email" name="guardian_email" id="guardian_email">
                                                </div>
...
<?php echo $__env->make('layouts.school.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shacartc/school.tehub.in/resources/views/school-website/admission.blade.php ENDPATH**/ ?>