    ...
    <div class="body">
        ...
        <div class="main-body mt-3">
            <table class="full-width-table bill-info">
                @if ($subscriptionBill->subscription->package_type == 1 && ($subscriptionBill->subscription->student_charge > 0 || $subscriptionBill->subscription->staff_charge > 0))
                ...
                <tr>
                    ...
                    <th class="text-right">{{ $settings['currency_symbol'] }}
                        @if ($subscriptionBill->subscription->package_type == 1)
                            {{ number_format($subscriptionBill->amount - $addons_charges, 2) }}
                        @else
                            {{ number_format($subscriptionBill->subscription->charges, 2) }}
                        @endif
                    </th>
                </tr>
                    @php
