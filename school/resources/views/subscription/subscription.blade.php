                        ...
                        <div class="row">
                            ...
                            @if ($active_package)
                                <div class="form-group col-sm-12 col-md-3">
                                    <label for="">{{ __('charges') }} ({{ $system_settings['currency_symbol'] }})</label>
                                    {!! Form::text('charges', $active_package->charges, [
                                        'class' => 'form-control form-control-sm',
                                        'readonly',
                                    ]) !!}
                                </div>
                                @if ($active_package->package_type == 0)
                                    <div class="form-group col-sm-12 col-md-3">
                                        <label for="">{{ __('student_limit') }}</label>
                                        {!! Form::text('student_limit', $active_package->no_of_students, [
                                            'class' => 'form-control form-control-sm',
                                            'readonly',
                                        ]) !!}
                                    </div>
                                    <div class="form-group col-sm-12 col-md-3">
                                        ...
                                        {!! Form::text('staff_limit', $active_package->no_of_staffs, [
                                            'class' => 'form-control form-control-sm',
                                            'readonly',
                                        ]) !!}
                                    </div>
                            ...
                            @if ($active_package)
                                <div class="form-group col-sm-12 col-md-12 table-responsive">
                                    <table class="table table-bordered" data-mobile-responsive="true">
                                        ...
                                        @if ($active_package->package_type == 1 && ($active_package->student_charge > 0 || $active_package->staff_charge > 0)) 
