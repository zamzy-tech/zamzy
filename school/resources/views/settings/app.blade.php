                ...
                <div class="card">
                    <div class="card-body">
                        <form id="formdata" class="create-form-without-reset" action="{{ route('system-settings.app.update') }}" novalidate="novalidate">
                            ...
                            {{-- Admin app --}}
                            <h4 class="card-title">
                                {{ __('Admin App Settings') }}
                            </h4>
                            <div class="pt-3 row">
                                <div class="form-group col-md-6 col-sm-12">
                                    <label for="admin_app_link">{{ __('app_link') }} </label>
                                    <input name="admin_app_link" id="admin_app_link" value="{{ $settings['admin_app_link'] ?? '' }}" type="url" placeholder="{{ __('app_link') }}" class="form-control"/>
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label for="admin_ios_app_link">{{ __('ios_app_link') }} </label>
                                    <input name="admin_ios_app_link" id="admin_ios_app_link" value="{{ $settings['admin_ios_app_link'] ?? '' }}" type="url" placeholder="{{ __('ios_app_link') }}" class="form-control"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-3 col-sm-12">
                                    <label for="admin_app_version">{{ __('app_version') }} </label>
                                    <input name="admin_app_version" id="admin_app_version" value="{{ $settings['admin_app_version'] ?? '' }}" type="text" placeholder="{{ __('app_version') }}" class="form-control"/>
                                </div>
                                <div class="form-group col-md-3 col-sm-12">
                                    <label for="admin_ios_app_version">{{ __('ios_app_version') }} </label>
                                    <input type="text" name="admin_ios_app_version" id="admin_ios_app_version" placeholder="{{ __('ios_app_version') }}" class="form-control" value="{{ $settings['admin_ios_app_version'] ?? '' }}">
                                </div>
                                <div class="form-group col-md-3 col-sm-12">
                                    <label>{{ __('force_app_update') }}</label>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" value="{{ $settings['admin_force_app_update'] ?? 0 }}" id="admin_force_app_update">{{ __('force_app_update') }}
                                            <i class="input-helper"></i>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group col-md-3 col-sm-12">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" value="{{ $settings['admin_app_maintenance'] ?? 0 }}" id="admin_app_maintenance">{{ __('app_maintenance') }}
                                            <i class="input-helper"></i>
                                        </label>
                                    </div>
