                        ...
                        <form class="pt-3" id="create-form" action="{{ route('class-group.store') }}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    {!! Form::select('class_ids[]', $classes, null, ['class' => 'form-control select2-dropdown select2-hidden-accessible','multiple']) !!}
                                </div>
                        ...
                        <form class="pt-3 subject-edit-form" id="edit-form" action="{{ url('class-group') }}"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('class_ids[]', $classes, null, ['class' => 'form-control select2-dropdown select2-hidden-accessible','multiple','id' => 'edit_class_ids']) !!}
                                </div>
                            </div>
