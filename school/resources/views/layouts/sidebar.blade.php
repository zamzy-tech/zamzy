                ...
                <div class="collapse" id="exam-menu">
                    <ul class="nav flex-column sub-menu">
                        @can('exam-create')
                            ...
                            <li class="nav-item">
                                <a href="{{ route('exams.hall-ticket') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('Exam Management')"> {{ __('Generate Hall Ticket') }}
                                </a>
                            </li>
                        @endcan
                        @can('view-exam-marks')
                ...
                <div class="collapse" id="settings-menu">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @can('email-template')
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('school-settings.whatsapp.template') }}">{{ __('WhatsApp Template') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('school-setting-manage')
                        <li class="nav-item">
                            <a class="nav-link" data-access="@hasAnyFeatureAccess(['Website Management','WhatsApp SMS'])" href="{{ route('school-settings.third-party') }}">{{ __('Third-Party APIs') }}</a>
                        </li>
                        @endcan
