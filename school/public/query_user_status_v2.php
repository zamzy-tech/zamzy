...
try {
    ...
    $stmt = $pdo->query("SELECT id, name, code, support_email, database_name, status, admin_id FROM schools ORDER BY id DESC LIMIT 1");
    ...
    if ($u) {
        ...
        echo "\nADMIN USER NOT FOUND IN CENTRAL (ID: " . $school['admin_id'] . ")\n";
    }
