...
class ClassSection extends Model {
    ...
    public function getNameAttribute() {
        ...
        $isSchool7 = false;
        if (config('database.connections.school.database') === 'shacartc_eschool_saas_7_brilliant') {
            $isSchool7 = true;
        } elseif (session()->get('school_database_name') === 'shacartc_eschool_saas_7_brilliant') {
            $isSchool7 = true;
        } elseif (isset($this->school_id) && $this->school_id == 7) {
            $isSchool7 = true;
        } elseif (Auth::check() && Auth::user()->school_id == 7) {
            $isSchool7 = true;
        }

        if (!$isSchool7 && $this->relationLoaded('section')) {
