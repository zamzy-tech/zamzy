...
class WebSettingsController extends Controller
{
    ...
    public function index()
    {
        if (env('STANDALONE_SCHOOL')) {
            return redirect()->route('school.web-settings.index');
        }
    ...
    public function school_store(Request $request)
    {
        ...
        $settings = [
            ...
            "instagram_name" => 'nullable',
            "instagram_icon" => 'nullable',
            "linkedin_name" => 'nullable',
