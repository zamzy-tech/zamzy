...
class SystemSettingsController extends Controller {
    ...
    public function appSettingsIndex() {
        ...
        $names = array(
            'app_link', 'ios_app_link', 'app_version', 'ios_app_version', 'force_app_update', 'app_maintenance', 
            'teacher_app_link', 'teacher_ios_app_link', 'teacher_app_version', 'teacher_ios_app_version', 'teacher_force_app_update', 'teacher_app_maintenance',
            'admin_app_link', 'admin_ios_app_link', 'admin_app_version', 'admin_ios_app_version', 'admin_force_app_update', 'admin_app_maintenance'
        );
    ...
    public function appSettingsUpdate(Request $request) {
        ...
        try {
            $settings = [
                ...
                'admin_ios_app_link',
                'admin_app_version',
                'admin_ios_app_version',
                'admin_force_app_update',
                'admin_app_maintenance',
            ];
            foreach ($settings as $row) {
                $data[] = [
                    'name' => $row,
