        ...
        <div class="contact-card-box">
          ...
          <div class="contact-card-text">
            ...
            <a href="https://wa.me/917287060553?text=Hello%20ZAMZY!%20I%20am%20contacting%20from%20your%20official%20website%20(zamzy.in).%20I%20would%20like%20to%20inquire%20about%20your%20software%20and%20digital%20services."
              target="_blank" class="contact-card-link">+91 72870 60553 (WhatsApp Chat)</a><br />
          ...
          <div class="form-grid">
            ...
            <div class="form-group">
              <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:0.45rem;">
                <label class="form-label" for="contact-phone" style="margin-bottom:0;">WhatsApp / Mobile Number <span class="req">*</span></label>
                <span id="contact-phone-verified-badge" style="display:none; font-family:var(--mono); font-size:0.68rem; color:#10b981; font-weight:700;">✓ Verified</span>
              </div>
              <div style="display:flex; gap:6px;">
                <input type="tel" id="contact-phone" class="form-input" placeholder="e.g. +91 98765 43210" style="margin-bottom:0; flex:1;" required />
                <button type="button" id="btn-send-contact-otp" class="btn btn-sm" style="background:rgba(37,211,102,0.15); border:1px solid #25D366; color:#25D366; font-family:var(--mono); font-size:0.75rem; font-weight:700; padding:0 12px; border-radius:8px; cursor:pointer; white-space:nowrap; transition:all 0.2s ease;">
                  💬 Verify
                </button>
              </div>

              <!-- OTP Verification Row (Hidden until requested) -->
              <div id="contact-otp-row" style="display:none; margin-top:8px; padding:10px; background:rgba(37,211,102,0.06); border:1px dashed rgba(37,211,102,0.4); border-radius:8px;">
                <div style="font-size:0.7rem; color:#86efac; font-family:var(--mono); margin-bottom:6px;">
                  📲 Enter 4-digit code sent to your WhatsApp:
                </div>
                <div style="display:flex; gap:6px;">
                  <input type="text" id="contact-otp-input" maxlength="6" class="form-input" placeholder="e.g. 1234" style="padding:0.5rem 0.8rem; font-family:var(--mono); letter-spacing:0.15em; font-weight:700; text-align:center; width:120px; margin-bottom:0;" />
                  <button type="button" id="btn-confirm-contact-otp" class="btn btn-sm" style="background:#25D366; color:#03230e; font-family:var(--mono); font-weight:800; font-size:0.75rem; padding:0 14px; border-radius:6px; border:none; cursor:pointer;">
                    Confirm OTP
                  </button>
                </div>
                <div id="contact-otp-feedback" style="font-family:var(--mono); font-size:0.72rem; margin-top:5px; line-height:1.4;"></div>
              </div>
            </div>
    ...
    <div class="footer-inner">
      ...
      <div>
        ...
        <div class="footer-links-col" style="font-size:0.82rem; color:var(--dim); line-height:1.7;">
          ...
          <p>💬 <a href="https://wa.me/917287060553?text=Hello%20ZAMZY!%20I%20am%20contacting%20from%20your%20official%20website%20(zamzy.in).%20I%20would%20like%20to%20inquire%20about%20your%20software%20and%20digital%20services." target="_blank"
              style="color:var(--cyan); text-decoration:underline;">+91 72870 60553 (WhatsApp)</a></p>
          ...
          <div class="social-circle-links">
            ...
            <a href="https://wa.me/917287060553?text=Hello%20ZAMZY!%20I%20am%20contacting%20from%20your%20official%20website%20(zamzy.in)." target="_blank" rel="noopener" class="social-circle-btn whatsapp" aria-label="WhatsApp" title="Chat on WhatsApp (+91 72870 60553)">
              <svg viewBox="0 0 24 24"><path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.816 9.816 0 0 0 12.04 2m.01 1.67c2.2 0 4.26.86 5.82 2.42a8.225 8.225 0 0 1 2.41 5.83c0 4.54-3.7 8.24-8.24 8.24-1.48 0-2.93-.4-4.2-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.196 8.196 0 0 1-1.26-4.38c0-4.54 3.7-8.24 8.24-8.24m4.52 11.59c-.25-.12-1.47-.72-1.7-.81-.23-.08-.39-.12-.56.12-.17.25-.64.81-.79.98-.14.17-.29.19-.54.06-.25-.12-1.05-.39-2-1.23-.74-.66-1.24-1.47-1.38-1.72-.15-.25-.02-.38.11-.5.11-.11.25-.29.37-.43.12-.14.17-.25.25-.41.08-.17.04-.31-.02-.43s-.56-1.34-.76-1.84c-.2-.48-.41-.42-.56-.43h-.48c-.17 0-.43.06-.66.31-.22.25-.86.84-.86 2.06 0 1.21.88 2.39 1 2.56.12.17 1.74 2.66 4.21 3.73.59.25 1.05.41 1.41.52.59.19 1.13.16 1.56.1.48-.07 1.47-.6 1.67-1.18.21-.58.21-1.07.14-1.18-.06-.11-.23-.17-.48-.29"/></svg>
            </a>
          </div>
        </div>
      </div>
