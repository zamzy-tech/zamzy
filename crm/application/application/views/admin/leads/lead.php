...
<div class="modal-header">
    ...
    <div class="tw-flex tw-justify-between tw-items-center">
        ...
        <?php if (isset($lead)) { ?>
        <?php $public_status_url = site_url('lead/status/' . $lead->id . '/' . md5($lead->id . APP_ENC_KEY)); ?>
        <a href="#"
            class="tw-text-neutral-500 hover:tw-text-neutral-800 focus:tw-text-neutral-800 tw-mt-1 tw-space-x-1.5 tw-mx-4"
            onclick="navigator.clipboard.writeText('<?= $public_status_url; ?>'); alert('Public status link copied to clipboard!'); return false;">
