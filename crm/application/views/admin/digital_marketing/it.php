...
.dm-stat-purple { background: linear-gradient(135deg,#6a1b9a,#311b92); }
.dm-stat-teal   { background: linear-gradient(135deg,#00bcd4,#006064); }
    ...
    <div class="content-inner">
        <div class="container-fluid">
            ...
            <div class="dm-header-card">
                <h2><i class="fa fa-code" style="margin-right:10px;"></i>IT LDS Lead</h2>
                <p>Manage leads captured through IT Solutions & Software digital marketing campaigns.</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    ?>
                    <div class="dm-stat-box dm-stat-teal">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <h5 style="font-weight:700; margin-bottom:14px;"><i class="fa fa-link" style="color:#6a1b9a;"></i> Public Lead Capture URL</h5>
                    <div class="dm-url-box">
                        <i class="fa fa-globe" style="color:#6a1b9a; font-size:18px;"></i>
                        <span id="it_public_url"><?= e($public_url); ?></span>
                    ...
                    <small class="text-muted"><i class="fa fa-info-circle"></i> Share this URL in your IT software and website ads. Leads submitted through this form will appear in this table automatically.</small>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading" style="display:flex; align-items:center; justify-content:space-between;">
                    <h3 class="panel-title"><i class="fa fa-users"></i> Leads — IT LDS (<?= count($leads); ?>)</h3>
                ...
                <div class="panel-body">
                    <?php if (count($leads) === 0): ?>
                        <div class="alert alert-info text-center">
                            <i class="fa fa-info-circle"></i> No IT LDS leads found yet. Share the public form URL to start collecting leads!
                        </div>
                    <?php else: ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered dm-leads-table" id="itLeadsTable">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Name</th>
...
<div class="modal fade" id="addLeadModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background:linear-gradient(135deg,#6a1b9a,#311b92); color:#fff; border-radius:4px 4px 0 0;">
                <button type="button" class="close" data-dismiss="modal" style="color:#fff; opacity:1;"><span>&times;</span></button>
                <h4 class="modal-title"><i class="fa fa-plus-circle"></i> Add IT LDS Lead</h4>
            </div>
            <form id="addLeadForm">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="e.g. Suresh Patel" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control" placeholder="e.g. suresh@business.com">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="description" class="form-control">
                                    ...
                                    <option value="ERP / CRM Solution">ERP / CRM Solution</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="lead_value" class="form-control" placeholder="e.g. 50000" min="0">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
function copyUrl() {
    var url = document.getElementById('it_public_url').innerText;
...
$('#filterStatus, #filterSearch').on('change keyup', function() {
    ...
    $('#itLeadsTable tbody tr').each(function() {
