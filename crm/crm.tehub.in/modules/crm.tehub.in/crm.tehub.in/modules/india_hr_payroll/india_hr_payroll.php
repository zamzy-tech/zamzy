...
/*
Module Name: India HR, Payroll & Employee Compliance Vault
Description: Comprehensive HR suite for India (Andhra Pradesh & all states) - 16-slot Employee Document Vault, Offer & Joining Letter Generator, Monthly Payroll (Basic + HRA - PF/ESI/PT/TDS), Payslip PDFs, EPFO ECR & ESIC Reports.
Version: 1.0.0
...
function india_hr_payroll_admin_init_hook()
{
     ...
     */
    if (has_permission('india_hr_payroll', '', 'view')) {
        $CI->app_menu->add_sidebar_menu_item('india-hr-payroll', [
            'name'     => 'HR & Payroll (India)',
